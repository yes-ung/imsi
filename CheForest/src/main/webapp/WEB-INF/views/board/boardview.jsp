        ...
        <div class="post-header">
          ...
          <div class="author-section">
            ...
            <div class="action-buttons">
              ...
              <!-- 즐겨찾기 수는 DTO에 없으므로 0 고정 또는 숨김 -->
              <button class="action-btn bookmark-btn" id="bookmarkBtn" type="button" title="북마크">
                        ...
                        <div class="instruction-image">
                          <c:choose>
                            <c:when test="${not empty step.image}">
                              <img src="<c:out value='${step.image}'/>" alt="조리 이미지"/>
                            </c:when>
                            <c:otherwise>
...
<!-- 피그마 기본 JS 없이도 최소 기능 동작: 탭/좋아요 토글 -->
<script>
